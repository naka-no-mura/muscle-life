                    ...
                    <div className="mt-16">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <p className="my-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    PFCとトレーニングの管理
                                </p>

                                <div>
                                    <p className='text-gray-900 dark:text-white'>アカウントをすでにお持ちの方</p>
                                    <Link
                                        href={route('login')}
                                        className="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                                    >
                                ...
                                <div>
                                    <p className='text-gray-900 dark:text-white'>初めてご利用される方</p>
                                    <div className="mt-4">
